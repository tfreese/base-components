...
public abstract class AbstractJFreeChartScriplet<T>
{
	 ...
	 */
	private static double[] DEFAULT_TICKS = new double[]
	{
			0.01D,
			0.02D,
			0.03D,
	 ...
	 * 
	 */
	private DecimalFormat floatFormatter = null;

	/**
	 * Erstellt ein neues {@link AbstractJFreeChartScriplet} Objekt.
	 */
	public AbstractJFreeChartScriplet()
	{
		super();
	}
	 ...
	 * Fuer die Dekorierung des Diagramms die {@link #decorateChart(Object, JFreeChart)} Methode
	 * aufrufen.
	 * 
	 * @param model Object
	...
	/**
	 * Berechnet den Schrittwert fuer eine Skalierung mit Angabe der Anzahl der Schritte und einen
	 * moeglichen oberen Rand in %.
	 * 
	 ...
	 */
	protected double calculateTick(final double yMaxValue, final int maxTickUnits,
									final double upperTickMargin, final boolean fractionDigits)
	{
	 ...
	 */
	protected abstract void decorateRenderer(final T model, Plot plot, final int index,
												final LegendItemSource renderer);
	 ...
	 * @param fractionDigits boolean, Ticks mit Kommastellen ?
	 */
	protected void normalizeYTickUnits(final ValueAxis axis, final double yMaxValue,
										final int maxTickUnits, final double upperTickMargin,
