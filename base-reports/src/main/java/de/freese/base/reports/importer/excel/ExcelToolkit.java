...
public final class ExcelToolkit
{
	...
	public static boolean overlapRanges(final String range1, final String range2)
	{
		...
		Rectangle r1 =
				new Rectangle(r1FirstCol, r1FirstRow, (r1LastCol - r1FirstCol) + 1,
						(r1LastRow - r1FirstRow) + 1);
		Rectangle r2 =
				new Rectangle(r2FirstCol, r2FirstRow, (r2LastCol - r2FirstCol) + 1,
						(r2LastRow - r2FirstRow) + 1);
