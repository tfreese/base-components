...
/**
 * Blockiert die gesamte Anwendung mit einer GlassPane und zeigt den Titel des Tasks und den
 * Progress-Wert an.
 * 
...
public class DefaultGlassPaneInputBlocker extends AbstractGlassPaneInputBlocker
{
	 ...
	 */
	public DefaultGlassPaneInputBlocker(final AbstractTask<?, ?> task, final Component target)
	{
		super(task, target);
	...
	/**
	 * @see de.freese.base.swing.task.inputblocker.AbstractGlassPaneInputBlocker#handleTaskEvent(java.beans.PropertyChangeEvent)
	 */
	@Override
	protected void handleTaskEvent(final PropertyChangeEvent evt)
	{
		...
		if ("progress".equals(propertyName))
		{
			...
			this.progressBar.setValue(Integer.parseInt(evt.getNewValue().toString()));
