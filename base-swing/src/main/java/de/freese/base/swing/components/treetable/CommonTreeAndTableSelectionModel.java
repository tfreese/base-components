...
public class CommonTreeAndTableSelectionModel extends DefaultTreeSelectionModel
{
	...
	/**
	 * {@link ListSelectionModel}, welche bei Aenderung des SelectionModes das
	 * {@link TreeSelectionModel} aktualisiert.
	 * 
	 * @author Thomas Freese
	 */
	 ...
	 */
	private boolean updatingListSelectionModel = false;
	...
	/**
	 * If <code>updatingListSelectionModel</code> is false, this will reset the selected paths from
	 * the selected rows in the list selection model.
	 */
	...
	/**
	 * Aktualisiert den SelectionMode des {@link TreeSelectionModel}s ohne synchronisierung des
	 * {@link ListSelectionModel}s.
	 * 
	 * @param mode int
	 */
