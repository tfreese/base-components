...
/**
 * Komponente zum Rendern der Sortierung auf einer Tabellenspaltenueberschrift.
 * 
...
public class SortRendererComponent extends JPanel
{
	 ...
	 */
	public SortRendererComponent(final JComponent mainComponent, final Icon sortIcon,
			final String priority, final Color textSortColor)
	{
		super();
