 ...
 */
public abstract class AbstractEventListComboBoxModel<T> extends AbstractEventListListModel<T>
		implements ComboBoxModel<T>
{
	...
	private class ComboBoxEventListListener extends EventListListener
	{
		...
		/**
		 * Ueberschrieben, um sicherzustellen, das das selektierte Objekt in der ComboBox angepasst
		 * wird, wenn sich die Daten der {I EventList} anpassen.
		 * 
	 ...
	 */
	public AbstractEventListComboBoxModel(final IEventList<T> list)
	{
		super(list);
	}
	...
	/**
	 * Ueberschrieben, da beim Entfernen von Objekten auch das selektierte Objekt der ComboBox
	 * angepasst werden muss.
	 * 
	 * @see de.freese.base.swing.components.list.model.AbstractEventListListModel#fireIntervalRemoved(java.lang.Object,
	 *      int, int)
	 */
	@Override
