...
/**
 * KeySelectionManager einer ComboBox. Dieser sucht auf Tastendruck einen Eintrag aus der Combobox,
 * der mit einer eingegebenen Zeichfolge uebereinstimmt. Diese Zeichenfolge wird mit dem Wert aus
 * dem {@link ListCellRenderer} verglichen. Des Weiteren kann nach Zeichenketten in der ComboBox
 * gesucht werden, in dem innerhalb kurzer Zeit aufeinanderfolgende Tastendruecke erfolgen.
 * 
...
public class RendererKeySelectionManager implements KeySelectionManager
{
	...
	private String getString(final int row)
	{
		...
		Component rendererComponent =
				this.comboBox.getRenderer().getListCellRendererComponent(this.list, value, row,
						false, false);
	...
	/**
	 * Bestimmt die Zeichenfolge, nach der im {@link ComboBoxModel} gesucht werden soll. Wenn
	 * innerhlab von 250 ms nach einem Tastendruck erneut eine Taste gedrueckt wird, so wird das
	 * Tastaturzeichen an die bestehende Zeichenfolge angehaengt.
	 * 
	 * @param aKey char
	 */
