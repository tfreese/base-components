...
{
	/**
	 * Erstellt ein neues {@link TreeFontChangeHandler} Object.
	 */
	public TreeFontChangeHandler()
	{
		super();
	}
	...
	public void fontChanged(final Font newFont, final Object object)
	{
		...
		Component cellEditorComponent =
				cellEditor.getTreeCellEditorComponent(tree, tree.getModel().getRoot(), false,
						false, false, 0);
