...
public class ExtUndoManager extends UndoManager
{
	...
	/**
	 * Erstellt ein neues {@link ExtUndoManager} Object.
	 */
	public ExtUndoManager()
	{
		super();
	...
	/**
	 * Liefert eine unmodifiableList der vorhandenen {@link UndoableEdit}s, welche noch ein Undo
	 * ausfuehren koennen.
	 * 
	 * @return {@link List}
	 */
