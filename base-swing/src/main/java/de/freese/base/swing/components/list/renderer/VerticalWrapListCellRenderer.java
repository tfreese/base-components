...
/**
 * {@link ListCellRenderer} fuer eine Liste mit Vertical-Wrap.
 * 
...
public class VerticalWrapListCellRenderer<T> implements ListCellRenderer<T>
{
	...
	/**
	 * Erstellt ein neues {@link VerticalWrapListCellRenderer} Objekt.<br>
	 * Als Default wird der {@link NameProviderListCellRenderer} verwendet.
	 */
	@SuppressWarnings("unchecked")
	public VerticalWrapListCellRenderer()
	{
		this((ListCellRenderer<T>) new NameProviderListCellRenderer());
	}
	...
	{
		Component component =
				this.delegate.getListCellRendererComponent(list, value, index, isSelected,
						cellHasFocus);
		...
		if ((index >= visibleRowCount) && (component instanceof JComponent))
		{
			...
			Border compoundBorder =
					BorderFactory.createCompoundBorder(this.matteBorder, jComponent.getBorder());
