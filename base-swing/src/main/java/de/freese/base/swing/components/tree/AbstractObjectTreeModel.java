...
/**
 * Basis TreeModel, welches die Verwendung von normalen Objekten ermoeglicht ohne jedesmal einen
 * TreeNode erzeugen zu muessen.
 * 
...
public abstract class AbstractObjectTreeModel implements TreeModel
{
	 ...
	 */
	protected void fireTreeNodesChanged(final Object source, final Object[] pathToRoot,
	 ...
	 * @see EventListenerList
	 */
	protected void fireTreeNodesInserted(final Object source, final Object[] pathToRoot,
											final int[] childIndices, final Object[] children)
	{
		synchronized (this.eventListenerList)
		{
	 ...
	 * @see EventListenerList
	 */
	protected void fireTreeNodesRemoved(final Object source, final Object[] pathToRoot,
										final int[] childIndices, final Object[] children)
	{
		synchronized (this.eventListenerList)
		{
	 ...
	 * @see EventListenerList
	 */
	protected void fireTreeStructureChanged(final Object source, final Object[] pathToRoot,
											final int[] childIndices, final Object[] children)
	{
		synchronized (this.eventListenerList)
		{
	...
	/**
	 * Liefert fuer einen Parent die entsprechende {@link List} der Childobjecte.
	 * 
	 * @param parent Object
	 * @return {@link List}
	 */
	...
	/**
	 * Liefert den Parent fuer das Child Objekt. Durchlaeuft dabei den Baum rekursiv durch die
	 * Pfade.
	 * 
	 * @param child Object
	 * @return Object
	...
	/**
	 * Wird von getParentFor(Object child) mit Root als Parent aufgerufen und durchsucht den Baum
	 * rekursiv durch die Pfade.
	 * 
	 * @param parent Object
	 * @param child Object
	 * @return Object
	...
	/**
	 * Invoke this method after you've inserted some TreeNodes into node. childIndices should be the
	 * index of the new elements and must be sorted in ascending order.
	 * 
	 * @param node Object
	 * @param childIndices int[]
	 */
	public void nodesWereInserted(final Object node, final int[] childIndices)
	{
		synchronized (this.eventListenerList)
		{
			if ((this.eventListenerList != null) && (node != null) && (childIndices != null)
	...
	/**
	 * Invoke this method after you've removed some TreeNodes from node. childIndices should be the
	 * index of the removed elements and must be sorted in ascending order. And removedChildren
	 ...
	 */
	public void nodesWereRemoved(final Object node, final int[] childIndices,
	...
	/**
	 * Invoke this method if you've modified the TreeNodes upon which this model depends. The model
	 * will notify all of its listeners that the model has changed below the node <code>node</code>
	 * (PENDING).
	 * 
	 * @param node Object
	 */
