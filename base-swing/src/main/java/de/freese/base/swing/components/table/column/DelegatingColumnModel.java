...
/**
 * Delegator fuer ein {@link TableColumnModel}. Damit wird sichergestellt dass die Spaltenbreiten
 * dieselben sind, wie die Tabelle mit dem uebergebenden {@link TableColumnModel}. Zusaetzlich wird
 * verhindert, das beide ColumnModels das gleiche Selectionmodel haben.<br>
 * Achtung!!!: Die Methoden removeColumn(), getSelectedColumns(), getSelectedColumnCount()<br>
 * und moveColumn() muessen angepasst werden, wenn das SelectionModel richtig funktioneren soll.
 * 
