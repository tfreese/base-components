...
/**
 * Diese Klasse verwaltet die einzelnen {@link AbstractTask}s und dient als Model fuer
 * GUI-Komponenten.
 * 
...
public final class TaskService
{
	...
	private class TaskPCL implements PropertyChangeListener
	{
		...
		public void propertyChange(final PropertyChangeEvent evt)
		{
			...
			// System.out.println("TaskService.TaskPCL.propertyChange(): " + propertyName);
	...
	public static class TaskServiceThreadFactory implements ThreadFactory
	{
		...
		private TaskServiceThreadFactory()
		{
			...
			this.group =
					(sm != null) ? sm.getThreadGroup() : Thread.currentThread().getThreadGroup();
			this.namePrefix =
					"TaskService-" + TaskServiceThreadFactory.queueNumber.getAndIncrement()
							+ "-thread-";
		}
	...
	public void execute(final AbstractTask<?, ?> task)
	{
		...
		getExecutorService().execute(
				new NamePreservingRunnable(task, task.getClass().getSimpleName()));
	}
