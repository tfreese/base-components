...
public class GroupableTableHeader extends JTableHeader
{
	 ...
	 * 
	 */
	protected final List<GroupableColumn> columnGroups = Collections
			.synchronizedList(new ArrayList<GroupableColumn>());
	...
	public List<Object> getColumnGroups(final TableColumn tableColumn)
	{
		...
		for (GroupableColumn groupableColumn : this.columnGroups)
		{
			...
			{
				List<Object> groups =
						groupableColumn.getColumnGroups(tableColumn, new ArrayList<>());
