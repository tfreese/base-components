...
/**
 * ListCellRenderer, dem ein Fieldname uebergeben wird, und der seine Objekte ueber Reflection zur
 * Anzeige bringt.
 * 
...
public class GenericFieldListCellRenderer extends AbstractGenericListCellRenderer
{
	...
	/**
	 * @see de.freese.base.swing.components.list.renderer.AbstractGenericListCellRenderer#getString(java.lang.Object,
	 *      java.lang.String)
	 */
	@Override
