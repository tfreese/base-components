 ...
 */
public class FibonacciView extends AbstractView implements IFibonacciView
{
    /**
    ...
    /**
     * Erstellt ein neues {@link FibonacciView} Object.
     *
     * @param process {@link IFibonacciBP}
     * @param context {@link ApplicationContext}
     */
    public FibonacciView(final IFibonacciBP process, final ApplicationContext context)
    {
     ...
     */
    @Override
    public IFibonacciBP getProcess()
    {
        return (IFibonacciBP) super.getProcess();
    }
    ...
    public void initialize()
    {
        ...
        getComponent().getTextField().setText("40");
    ...
    /**
     * @see de.freese.base.demo.fibonacci.view.IFibonacciView#setResult(long)
     */
    @Override
