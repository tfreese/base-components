...
{
	/**
	 * Erstellt ein neues {@link IIOReadProgressAdapter} Object.
	 */
	...
	/**
	 * @see javax.imageio.event.IIOReadProgressListener#imageProgress(javax.imageio.ImageReader,
	 *      float)
	 */
	@Override
	...
	/**
	 * @see javax.imageio.event.IIOReadProgressListener#sequenceStarted(javax.imageio.ImageReader,
	 *      int)
	 */
	@Override
	...
	/**
	 * @see javax.imageio.event.IIOReadProgressListener#thumbnailProgress(javax.imageio.ImageReader,
	 *      float)
	 */
	@Override
	...
	/**
	 * @see javax.imageio.event.IIOReadProgressListener#thumbnailStarted(javax.imageio.ImageReader,
	 *      int, int)
	 */
	@Override
