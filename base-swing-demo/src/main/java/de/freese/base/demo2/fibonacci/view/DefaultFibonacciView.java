...
import de.freese.base.demo2.fibonacci.FibonacciController;
import de.freese.base.demo2.fibonacci.task.FibonacciTask;
...
public class DefaultFibonacciView extends AbstractView implements FibonacciView
{
    ...
    public void release()
    {
        getApplicationContext().getService(GuiStateManager.class).store(getComponent().getTextField(), "fibonacci.textfield");
