 ...
 * @see <a href="https://www.baeldung.com/guava-rate-limiter">com.google.common.util.concurrent.RateLimiter</a>
 */
public interface Throttle
{
     ...
     *
     */
    public static boolean sleepUninterruptibly = false;
    ...
    {
        return new NanoThrottle.GoldFish(permitsPerSecond, 0.1D, fair);
    }
