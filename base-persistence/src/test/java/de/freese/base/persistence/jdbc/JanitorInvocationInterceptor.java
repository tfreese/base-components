...
import de.freese.base.persistence.jdbc.client.JdbcClient;
...
public class JanitorInvocationInterceptor implements InvocationInterceptor {
    ...
    public void interceptTestMethod(final Invocation<Void> invocation, final ReflectiveInvocationContext<Method> invocationContext, final ExtensionContext extensionContext)
        ...
        final JdbcClient jdbcClient = invocationContext.getArguments().stream()
                .filter(JdbcClient.class::isInstance)
                .map(JdbcClient.class::cast)
                .findFirst()
                .orElse(null);
    ...
    private void createTable(final DbServerExtension serverExtension, final JdbcClient jdbcClient) {
