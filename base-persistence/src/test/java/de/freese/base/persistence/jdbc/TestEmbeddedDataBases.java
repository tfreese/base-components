...
class TestEmbeddedDataBases {
    ...
    void testTableWithAutoIncrement(final EmbeddedDatabaseType databaseType, final DbServerExtension server) throws Exception {
        final String sqlCreateTable = switch (databaseType) {
            ...
            case DERBY, H2 -> "CREATE TABLE person (id BIGINT NOT NULL GENERATED ALWAYS AS IDENTITY (START WITH 1 INCREMENT BY 1) NOT NULL PRIMARY KEY"
                    + ", last_name VARCHAR(50) NOT NULL, first_name VARCHAR(50) NOT NULL)";

            // Is always NOT NULL.
            case HSQL -> "CREATE TABLE person (id BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 1 INCREMENT BY 1) NOT NULL PRIMARY KEY, last_name VARCHAR(50) NOT NULL"
        ...
        final String sqlInsert = "INSERT INTO person (last_name, first_name) values (?, ?)";
