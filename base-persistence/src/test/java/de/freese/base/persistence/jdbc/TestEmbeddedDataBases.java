...
class TestEmbeddedDataBases {
    ...
    void testTableWithAutoIncrement(final EmbeddedDatabaseType databaseType, final DbServerExtension server) throws Exception {
        final String sqlCreateTable = switch (databaseType) {
            ...
            case DERBY, H2 -> "CREATE TABLE person (id BIGINT GENERATED ALWAYS AS IDENTITY (START WITH 1 INCREMENT BY 1) PRIMARY KEY, name VARCHAR(50) NOT NULL)";
            // case DERBY, H2 -> "CREATE TABLE person (id BIGINT DEFAULT NEXT VALUE FOR person_seq PRIMARY KEY, name VARCHAR(50) NOT NULL)";

            // Is always NOT NULL.
            case HSQL -> "CREATE TABLE person (id BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 1 INCREMENT BY 1) PRIMARY KEY, name VARCHAR(50) NOT NULL)";
        };
