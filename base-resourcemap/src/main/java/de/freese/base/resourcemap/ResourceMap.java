...
public class ResourceMap implements IResourceMap
{
     ...
     *
     */
    private final static Logger LOGGER = LoggerFactory.getLogger(ResourceMap.class);
     ...
     *
     */
    private final Map<Class<?>, IResourceConverter<?>> converters = new HashMap<>();
     ...
     *
     */
    private IResourceMap parent = null;
    ...
    /**
     * Erstellt ein neues {@link ResourceMap} Object.
     */
    public ResourceMap()
    {
        super();
    ...
    /**
     * @see de.freese.base.resourcemap.IResourceMap#addResourceConverter(de.freese.base.resourcemap.converter.IResourceConverter)
     */
    @Override
    ...
    /**
     * @see de.freese.base.resourcemap.IResourceMap#getBaseName()
     */
    @Override
    ...
    /**
     * @see de.freese.base.resourcemap.IResourceMap#getClassLoader()
     */
    @Override
    ...
    /**
     * @see de.freese.base.resourcemap.IResourceMap#getKeys()
     */
    @Override
    ...
    /**
     * @see de.freese.base.resourcemap.IResourceMap#getObject(java.lang.String, java.lang.Class)
     */
    ...
    public final <T> T getObject(final String key, final Class<T> type)
    {
        ...
        else
        {
            ...
            {
                IResourceConverter<?> stringConverter = getResourceConverter(type);
     ...
     */
    protected IResourceMap getParent()
    {
        return this.parent;
    }

    /**
     * @see de.freese.base.resourcemap.IResourceMap#getResourceConverter(java.lang.Class)
     */
    @Override
    public IResourceConverter<?> getResourceConverter(final Class<?> type)
    {
        IResourceConverter<?> converter = this.converters.get(type);
    ...
    /**
     * @see de.freese.base.resourcemap.IResourceMap#getResourceProvider()
     */
    @Override
    ...
    /**
     * @see de.freese.base.resourcemap.IResourceMap#getString(java.lang.String, java.lang.Object[])
     */
    @Override
    ...
    /**
     * @see de.freese.base.resourcemap.IResourceMap#setBaseName(java.lang.String)
     */
    @Override
    ...
    /**
     * @see de.freese.base.resourcemap.IResourceMap#setClassLoader(java.lang.ClassLoader)
     */
    @Override
    ...
    /**
     * @see de.freese.base.resourcemap.IResourceMap#setParent(de.freese.base.resourcemap.IResourceMap)
     */
    @Override
    public void setParent(final IResourceMap parent)
    {
        this.parent = parent;
    }

    /**
     * @see de.freese.base.resourcemap.IResourceMap#setResourceProvider(de.freese.base.resourcemap.provider.IResourceProvider)
     */
    @Override
