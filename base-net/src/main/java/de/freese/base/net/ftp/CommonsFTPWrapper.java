 ...
 */
public class CommonsFTPWrapper implements IFTPWrapper
{
	/**
	 *
	 */
	 ...
	 * 
	 */
	private ProtocolCommandListener protocolCommandListener = null;
	...
	/**
	 * @see de.freese.base.net.ftp.IFTPWrapper#changeWorkingDirectory(java.lang.String)
	 */
	@Override
	...
	/**
	 * @see de.freese.base.net.ftp.IFTPWrapper#changeWorkingDirectory(java.lang.String, boolean)
	 */
	@Override
	public void changeWorkingDirectory(final String path, final boolean createDirs)
		throws Exception
	{
		String m_path = path;
		...
		{
			m_path = m_path.replaceFirst("/", "");
		}

		m_path = m_path.replace('\\', '/');

		// Unterverzeichnisse auslesen
		String[] splits = m_path.split("[/]");
	...
	/**
	 * @see de.freese.base.net.ftp.IFTPWrapper#connect(java.lang.String)
	 */
	@Override
	...
	/**
	 * @see de.freese.base.net.ftp.IFTPWrapper#disconnect()
	 */
	@Override
	...
	protected ProtocolCommandListener getProtocolCommandListener()
	{
		...
		{
			this.protocolCommandListener = new PrintCommandListener(new PrintWriter(System.out));
		}
	...
	/**
	 * @see de.freese.base.net.ftp.IFTPWrapper#isDebug()
	 */
	@Override
	...
	/**
	 * @see de.freese.base.net.ftp.IFTPWrapper#login(java.lang.String, java.lang.String)
	 */
	@Override
	...
	/**
	 * @see de.freese.base.net.ftp.IFTPWrapper#logout()
	 */
	@Override
	...
	/**
	 * @see de.freese.base.net.ftp.IFTPWrapper#printWorkingDirectory()
	 */
	@Override
	...
	/**
	 * @see de.freese.base.net.ftp.IFTPWrapper#retrieveFile(java.lang.String)
	 */
	@Override
	...
	/**
	 * @see de.freese.base.net.ftp.IFTPWrapper#retrieveFile(java.lang.String, java.io.OutputStream)
	 */
	@Override
	public void retrieveFile(final String dateiName, final OutputStream outputStream)
		throws Exception
	{
	...
	/**
	 * @see de.freese.base.net.ftp.IFTPWrapper#setDebug(boolean)
	 */
	@Override
	...
	/**
	 * @see de.freese.base.net.ftp.IFTPWrapper#setPort(int)
	 */
	@Override
	...
	/**
	 * @see de.freese.base.net.ftp.IFTPWrapper#setTimeOut(int)
	 */
	@Override
	...
	/**
	 * @see de.freese.base.net.ftp.IFTPWrapper#storeFile(java.lang.String, java.io.InputStream)
	 */
	@Override
