...
public abstract class AbstractProtocol
{
	...
	/**
	 * Gets the APOP message digest. From RFC 1939: The 'digest' parameter is calculated by applying
	 * the MD5 algorithm [RFC1321] to a string consisting of the timestamp (including
	 * angle-brackets) followed by a shared secret. The 'digest' parameter itself is a 16-octet
